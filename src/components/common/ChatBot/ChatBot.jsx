...
//   // Simulate bot responses based on user input - adapted for Indian agriculture
//   const getBotResponse = (userInput) => {
//     const input = userInput.toLowerCase();
...
//     else if (input.includes('profit') || input.includes('money') || input.includes('income')) {
//       return {
//         text: "Maximizing profits in sustainable farming in India involves optimizing yields, reducing input costs, and accessing premium markets. The National Agricultural Market (e-NAM) can help you get better prices. Would you like to learn more about any of these aspects?",
...
//     else if (input.includes('organic') || input.includes('certification')) {
//       return {
//         text: "Organic certification in India requires following PGS-India or NPOP standards. The process involves documentation, inspections, and maintaining organic practices for at least 3 years. Would you like more details about the certification process?",
//         suggestions: ["Certification costs", "Organic standards", "Transition period", "Certification benefits"]
//       };
//     } 
...
//     else if (input.includes('water') || input.includes('irrigation')) {
//       return {
//         text: "Water conservation is crucial for sustainable farming in India. Techniques include drip irrigation, rainwater harvesting, and soil moisture monitoring. Government schemes like PM-KUSUM and PMKSY provide assistance. Which would you like to explore further?",
//         suggestions: ["Drip irrigation", "Rainwater harvesting", "Soil moisture sensors", "Water-efficient crops"]
//       };
//     } 
...
//     else if (input.includes('soil') || input.includes('fertility')) {
//       return {
//         text: "Healthy soil is the foundation of sustainable farming. Building soil fertility involves cover cropping, crop rotation, composting, and minimal tillage. You can get soil testing done under the Soil Health Card Scheme in India. What aspect interests you most?",
//         suggestions: ["Cover crops", "Composting", "No-till farming", "Soil testing"]
//       };
//     } 
...
//     else if (input.includes('pest') || input.includes('disease')) {
//       return {
//         text: "Sustainable pest management uses integrated approaches like biological controls, crop diversity, and targeted interventions. Neem-based products are widely used in India. Would you like to learn more about specific strategies?",
//         suggestions: ["Biological controls", "Companion planting", "Crop rotation for pest control", "Natural pesticides"]
//       };
//     } 
...
//       return {
//         text: "The Indian government offers several schemes for sustainable farming. PKVY (Paramparagat Krishi Vikas Yojana), MIDH, PM-KUSUM, and PMKSY are major programs. These include subsidies, training, and market linkages. Which scheme would you like to know more about?",
...
//       return {
//         text: "India's diverse climate influences regional farming practices. North India is known for wheat and rice, West for spices, South for coconut and spices, and East for rice cultivation. Which region would you like to learn about?",
...
//     else if (input.includes('resources') || input.includes('learn') || input.includes('guide')) {
//       return {
//         text: "We have many resources available! Check out our guides, videos, and tools in the Resources section of our website. Krishi Vigyan Kendra (KVK) and Indian Council of Agricultural Research (ICAR) also provide valuable information. Is there a specific topic you're interested in?",
//         suggestions: ["Farming guides", "Video tutorials", "Calculation tools", "Go to Resources page"]
//       };
//     } 
...
//       return {
//         text: "Sustainable practices for major crops in India are specific. SRI (System of Rice Intensification) for rice, zero tillage for wheat, and organic pest management for cotton are recommended. Which crop would you like to know more about?",
...
//       return {
//         text: "The Indian market for organic products is growing rapidly. You can sell your produce through e-NAM (Electronic National Agriculture Market) and APMC mandis. Organic certified products can fetch 20-40% premium. Would you like to know more about pricing or market access?",
